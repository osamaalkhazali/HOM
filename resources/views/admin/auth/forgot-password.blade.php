    ...
    <div class="min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="auth-card panel shadow-soft w-100" style="max-width: 420px;">
            <div class="panel-body p-4">
                ...
                <div class="text-center mb-4">
                    <h1 class="h3 mb-2 fw-bold" style="color: var(--primary-color);">Forgot Password?</h1>
                    <p class="text-muted mb-0">No problem. Just let us know your email address and we will email you a password reset link.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.password.email') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="email" type="email" name="email" class="form-control" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="admin@example.com">
                    </div>
