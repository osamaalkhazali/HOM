...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    /**
     * Send the email verification notification in the user's preferred language.
     */
    public function sendEmailVerificationNotification(): void
    {
        $locale = $this->preferred_language ?: config('app.locale');

        $this->notify((new LocalizedVerifyEmail())->locale($locale));
    }

    /**
     * Send the password reset notification in the user's preferred language.
     */
    public function sendPasswordResetNotification($token): void
    {
        $locale = $this->preferred_language ?: config('app.locale');

        $this->notify((new LocalizedResetPassword($token))->locale($locale));
    }
}
